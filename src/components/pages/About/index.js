		...
		<div className='page'>
			<div className='about'>
				...
				<div className='about-bio'>
					...
					<h3>With a background in design and five years of professional web development experience, I pride myself on making astonishing digital experiences. I earned a certificate in Full Stack Web Development from the University of Washington, where I developed skills in JavaScript, CSS, React.js, and responsive web design.</h3>
					<h3>An innovative problem solver, I'm passionate about developing apps with a focus on user-centered design and mobile-first development. My previous career in sales management and my web design experience has prepared me to approach problems with creativity and teamwork.</h3>
					<h3>With each project, I strive to deliver the most impactful user experience and design with purpose. I applied aspects of UX and agile development in a recent project where I led a team of 5 to develop a web application that utilized AI to dynamically build UI components.</h3>
					<h3>When I’m not designing or developing, I enjoy going to concerts, movies, trying out a new restaurant, or reading up on the latest design trends.</h3>
